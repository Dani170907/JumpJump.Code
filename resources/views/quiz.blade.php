    ...
    <script>
        ...
        function lockAnswer() {
            ...
            if (jawabanPemain === kunciJawaban) {
                ...
                // ==========================================
                // 1. Hero Melompat dan berubah jadi emas (Super Mode)
                ...
                setTimeout(() => {
                    ...
                    // Delay pindah map diperlama sedikit agar animasi selesai
                ...
                // Sisa logika penalti HP biarkan sama
                currentHp--;
                localStorage.setItem(hpKey, currentHp);
                renderHp();
        ...
        // FUNGSI BARU: Untuk tombol Reboot System di dalam Modal Game Over
